...
module.exports = {
  forbidden: [
    ...
    {
      name: "domain-strict-independence",
      comment: "Domain layer must not depend on any other layers.",
      severity: "error",
      from: { path: "^app/domain" },
      to: { path: "^app/(application|infrastructure|presentation|components)" },
    },
    {
      name: "date-fns-only-in-vo",
      comment: "Only value objects in the domain layer are allowed to depend on date-fns.",
      severity: "error",
      from: { path: "^app/domain", pathNot: "\\.vo\\.ts$" },
      to: { path: "date-fns" },
    },
    {
      name: "application-strict-independence",
      comment: "Application layer must not depend on other layers except domain layer. ",
      severity: "error",
      from: { path: "^app/application" },
      to: { path: "^app/(infrastructure|presentation|components)" },
    },
    {
      name: "presentation-not-to-infrastructure",
      comment: "Presentation layer must not depend on Infrastructure layer.",
      severity: "error",
      from: { path: "^app/presentation" },
    ...
    },
    {
      ...
      to: { path: "^app/(presentation|components)" },
    },
    {
      name: "components-independence",
      comment: "Common UI components must not depend on any other layers.",
      severity: "error",
      from: { path: "^app/components" },
      to: { path: "^app/(domain|application|infrastructure|presentation)" },
    },
    {
      name: "lib-independence",
      comment: "Common utility functions must not depend on any other layers.",
      severity: "error",
      from: { path: "^app/lib" },
      to: { path: "^app/(domain|application|infrastructure|presentation|components)" },
    },
  ],
  options: {
...
// generated: dependency-cruiser@17.3.10 on 2026-04-06T04:56:37.259Z
